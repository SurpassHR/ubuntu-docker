...
# Configure mysql client to default to TCP connection to avoid socket permission issues.
cat << EOF > /home/$SSH_USER/.my.cnf
[client]
host = 127.0.0.1
protocol = tcp
EOF
chown $SSH_USER:$SSH_USER /home/$SSH_USER/.my.cnf
